...
rowlim_T1_T1 = region_ct_T1;
collim_T1_T1 = region_ct_T1;
rowlim_T2_T2 = region_ct_T1+region_ct_T2;
collim_T2_T2 = region_ct_T1+region_ct_T2;
...
[rw_uncoupled,cl_uncoupled] = size(T1_T2_matrix);
for i=2:rw_uncoupled
    for j=2:cl_uncoupled
